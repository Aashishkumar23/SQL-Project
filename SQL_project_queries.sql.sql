--I made this project in which a dataset is used by me 
--and solving some questions, related to the dataset by the help of sql queries.
...
--#27. What are the top 5 companies with the highest average salaries for data scientist positions, and what is the rank of each company based on the average salary?
